                    ...
                    <div className="space-y-4">
                        {records.length > 0 ? records.map((record) => (
                            <div key={record.id} className="p-4 rounded-xl bg-secondary/10 border border-border/30 hover:border-primary/50 transition-all group animate-fade-in cursor-default">
                                ...
                                <div className="flex flex-wrap justify-between items-center text-[10px] text-muted-foreground font-mono pt-2 border-t border-border/20 gap-4">
                            ...
                            <p className="text-sm text-muted-foreground italic text-center py-12">No sentiment records identified in current cycle.</p>
                        )}
                    </div>
                )}
            </div>
