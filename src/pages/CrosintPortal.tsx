            ...
            <div className="glass-card p-6 min-h-[500px]">
                ...
                {loading ? (
                    <div className="flex flex-col items-center justify-center h-64 space-y-4">
                        ...
                        <p className="text-sm italic text-muted-foreground">Synchronizing intelligence buffers...</p>
                    </div>
                ) : reports.length === 0 ? (
                            ...
                            <div key={report.id} className="p-5 rounded-xl bg-secondary/10 border border-border/30 hover:border-primary/50 transition-all group animate-fade-in relative overflow-hidden">
                                ...
                                <div className="flex justify-between items-start mb-3">
                                    <div className="flex flex-wrap items-center gap-3">
                                        ...
                                        <span className="text-[10px] px-2 py-0.5 bg-sidebar-accent rounded border border-sidebar-border text-muted-foreground whitespace-nowrap">SOURCE: {report.data.source.toUpperCase()}</span>
                                        <span className={cn(
                                    ...
                                    <span className="text-[9px] text-muted-foreground font-mono whitespace-nowrap">{new Date(report.timestamp).toLocaleString()}</span>
                                </div>
